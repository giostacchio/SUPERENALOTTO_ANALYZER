const CACHE = 'pwa-SUPERENALOTTO_ANALYZER_V6_2-v1';
const CORE = ['./','./index.html','./styles.css','./app.js','./v62-single.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-192.png','./icon-maskable-512.png','./apple-touch-icon.png','./favicon.ico'];
